    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; min-height: 80px;">
        ...
        <ul class="nav navbar-top-links navbar-right login-logo-img" style="color:#5D7C0D; font-size:20px; ">
			<sec:authorize access="isAuthenticated() and hasRole('ROLE_MEMBER')">
				<sec:authentication property="principal.member.name"/> 기자님     
			</sec:authorize>
               ...
               <ul class="dropdown-menu dropdown-user">
                   <li>
					  <sec:authorize access="isAnonymous()">
                         <a href="#" onclick="openPopup('/member/customLogin', 'Login', 900, 700); return false;"><i class="fa fa-sign-in fa-fw"></i>&nbsp&nbsp&nbsp;로그인</a>
                         <a href="/member/signUp"><i class="fa fa-sign-in fa-fw"></i>&nbsp&nbsp&nbsp;회원가입</a>
                      </sec:authorize>
                      ...
                      <sec:authorize access="isAuthenticated()">
                         ...
                         <a href="#" onclick="openPopup('/member/passCheck', 'MemberUpdate', 900, 500); return false;"><i class="fa fa-sign-in fa-fw"></i>&nbsp&nbsp&nbsp;회원정보수정</a>
                      </sec:authorize>
                   </li>
               </ul>
               <!-- /.dropdown-user -->
